                                    ...
                                    @if ($properties && $properties->count())
                                        @foreach ($properties as $property)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('agent.property.show', $property->id) }}" class="text-white" style="text-decoration: none">
                                                ...
                                                <td style="white-space: nowrap;">
                                                    ...
                                                    @if ($imagePaths && is_array($imagePaths) && count($imagePaths) > 0)
                                                        @foreach ($imagePaths as $imagePath)
                                                            <img src="{{ asset($imagePath) }}" alt="Property Image" style="width: 30px; height: 30px; margin-right: 5px; display: inline-block;" class="img-circle">
                                                        @endforeach
                                                    @else
                                                ...
                                                <td class="text-end">
                                                    <a href="{{ route('agentproperties.edit', $property->id) }}" class="btn btn-primary">
                                                        <i class="bi bi-pencil-square text-white"></i>
                                                    </a>
                                                </td>
                                                <td>
                                                    <form action="{{ route('agentproperties.destroy', $property->id) }}" method="POST" style="display:inline;">
                                                        @csrf
                                                        @method('DELETE')
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content p-2">
                ...
                <form action="{{ route('agentproperties.store') }}" method="POST" enctype="multipart/form-data" class="container">
                    @csrf
                    @if ($errors->any())
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" name="posted_from" id="posted_from" class="form-control" value="{{ Auth::user()->id }}" disabled>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" name="location" id="location" class="form-control" required placeholder="e.g., New York, NY">
                            </div>
                        </div>
                    </div>
                    <div class="row">
